...
dst="${SCRIPT_DIR}/istio-generated.yaml"
{
  ...
  echo "# ---------------------------------------------------------"
  echo "# Gateway API CRDs (Standard Channel v${GATEWAY_API_VERSION})"
  echo "# See: https://docs.cloud.google.com/service-mesh/v1.27/docs/gateway/prepare-gateway#install_custom_resource_definitions"
  echo "# ---------------------------------------------------------"
  curl -fsSL "https://github.com/kubernetes-sigs/gateway-api/releases/download/v${GATEWAY_API_VERSION}/standard-install.yaml"
  echo "---"
  echo "# ---------------------------------------------------------"
