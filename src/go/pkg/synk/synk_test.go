...
// Strategic-merge-patches seems to have issues with dynamic fake clients, see here:
// https://github.com/kubernetes/client-go/issues/613
// since update to v0.22.2 of apimachinery etc. it does not work anymore and ends with this error
// --- FAIL: TestSynk_applyAllIsPatchingResources (112.71s)
//     synk_test.go:411: 1/1 resources failed to apply: /v1/ConfigMap/foo1/cm1: apply patch or update: unable to find api field in struct Unstructured for the json field "data"
//     synk_test.go:413: /v1/ConfigMap/foo1/cm1 action=Update error=apply patch or update: unable to find api field in struct Unstructured for the json field "data"
// FAIL
// However a manual test using synk cli tool with the same configmaps is working
