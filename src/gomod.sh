...
# bazel run //:gazelle -- update-repos -from_file=${DIR}/go.mod
# bazel run //:gazelle
...
gazelle update-repos -from_file=${DIR}/go.mod -to_macro=third_party/go_repositories.bzl%go_repositories -prune
gazelle update
