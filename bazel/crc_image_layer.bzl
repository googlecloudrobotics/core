...
def crc_image_layer(**kwargs):
    ...
    # rules_pkg's single-threaded Python gzip implementation.

    # This cut packaging time in half while remaining backwards-compatible with
    # older containerd versions (< 1.5) and Docker v2 Schema 2 base images.
